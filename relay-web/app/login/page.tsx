    ...
    <div className="w-full max-w-[480px] bg-surface-container-lowest p-8 md:p-12 shadow-sm border border-outline-variant/10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mb-8">
        <button
          ...
          className="flex items-center justify-center gap-3 py-3 px-4 bg-surface-container-lowest border border-outline-variant/30 text-on-surface text-sm font-medium hover:bg-surface-container-low transition-all duration-200"
        >
        ...
        <button
          ...
          className="flex items-center justify-center gap-3 py-3 px-4 bg-surface-container-lowest border border-outline-variant/30 text-on-surface text-sm font-medium hover:bg-surface-container-low transition-all duration-200"
        >
          <svg className="w-5 h-5 fill-on-surface shrink-0" viewBox="0 0 24 24">
      ...
      <div className="relative flex items-center mb-8">
        ...
        <span className="flex-shrink mx-4 text-secondary text-[10px] tracking-widest uppercase font-label">
          Or continue with
        </span>
        <div className="flex-grow border-t border-outline-variant/20" />
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="space-y-1">
          ...
          <input
            ...
            required
            className="w-full px-2 py-3 bg-surface-container-low border-b border-outline-variant/30 border-t-0 border-l-0 border-r-0 focus:ring-0 focus:border-primary focus:bg-surface-container-lowest transition-all duration-300 placeholder:text-outline-variant/60 text-on-surface text-sm outline-none"
          />
        </div>
      ...
      <div className="mt-8 text-center space-y-4">
        <p className="text-[12px] text-secondary leading-relaxed px-4">
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow flex items-center justify-center px-4 py-12 bg-surface-container-low">
        <Suspense
          fallback={<div className="text-sm text-secondary">Loading...</div>}
        >
          <LoginForm />
        </Suspense>
      </main>
